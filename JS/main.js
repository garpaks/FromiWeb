...
const lemas = [
  ...
  {
    texto:
      '"Nuestra mayor debilidad radica en darnos por vencidos. La forma más segura de tener éxito es siempre intentarlo una vez más."',
